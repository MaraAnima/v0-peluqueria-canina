...
function showTermsContent(event) {
  ...
  const termsContent = `
    <div style="text-align: left; max-height: 60vh; overflow-y: auto; padding-right: 10px; font-size: 14px; line-height: 1.6;">
      ...
      <p style="margin-bottom: 12px; color: #4a5568;">TR Corte brinda servicios de peluqueria canina que incluyen baño, secado, cepillado, limpieza de oidos, corte de uñas, corte higienico y perfume. Los servicios de corte de raza y deslanado no se encuentran incluidos en el servicio base y seran presupuestados de forma independiente segun las caracteristicas y estado del pelaje de la mascota.</p>
